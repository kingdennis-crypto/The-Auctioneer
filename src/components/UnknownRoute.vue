<template>
  <section class="bg-white dark:bg-gray-900">
    <img src="https://flowbite.s3.amazonaws.com/blocks/marketing-ui/404/404-computer.svg" width="500px"
      class="float-left" />
    <div class="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 lg:px-6">
      <div class="mx-auto max-w-screen-sm text-center">
        ...
        <p class="mb-4 text-lg font-light text-gray-500 dark:text-gray-400">Sorry, we can't find that page: {{ params }}. You'll find
